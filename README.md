...
NOTE: This sample submssion was inspired and lifted from the official [ADK-Samples](https://github.com/itgithubplatform/AI_agents_Intensive.git) repository. Special thanks to Pier Paolo Ippolito for his contributions. 
